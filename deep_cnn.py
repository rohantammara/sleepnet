...
def train(x_train, y_train, x_test, y_test):
    ...
    """
    save_point = ModelCheckpoint(filepath='saved_models/psg_deepmodel.h5', monitor='val_loss', save_best_only=True)
...
if __name__ == "__main__":
    ...
    try:
        classifier = load_model("saved_models/psg_deepmodel.h5")
